...
// Package puffin provides a reader and writer for the Puffin file format,
// which is used by Iceberg for storing auxiliary metadata like statistics
// and deletion vectors.
package puffin

// Core Puffin constants and shared data types.

// Magic is the Puffin file marker written at the start and end of the file.
